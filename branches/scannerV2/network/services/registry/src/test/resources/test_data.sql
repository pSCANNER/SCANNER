...
('MTM-1', 'MTM Sample Dataset 1', null, null, 2, 1, 100),
('BEARI-1', 'BEARI Sample Dataset 1', null, null, 3, 2, 100);
...
(2, 1, 400, 1, ' DataSetDefinition 1 will be analyzed with with GLORE Logistic Regression in a mode without approval before transfer of aggregate/patient-level data by role Principal Investigator.  ', 5, 2, 0, 0),
(2, 1, 400, 1, ' DataSetDefinition 1 will be analyzed with with GLORE Logistic Regression in a mode without approval before transfer of aggregate/patient-level data by role Investigator.  ', 7, 2, 0, 0),
(2, 1, 400, 1, ' DataSetDefinition 1 will be analyzed with with OCEANS Logistic Regression in a mode with approval before transfer of aggregate/patient-level data by role Principal Investigator.  ', 5, 1, 1, 0),
(2, 1, 400, 1, ' DataSetDefinition 1 will be analyzed with with OCEANS Logistic Regression in a mode with approval before transfer of aggregate/patient-level data by role Investigator.  ', 7, 1, 1, 0),
(2, 1, 400, 1, ' DataSetDefinition 1 will be analyzed with with OCEANS Logistic Regression in a mode without approval before transfer of aggregate/patient-level data by role Principal Investigator.  ', 5, 1, 0, 0),
(2, 1, 400, 1, ' DataSetDefinition 1 will be analyzed with with OCEANS Logistic Regression in a mode without approval before transfer of aggregate/patient-level data by role Investigator.  ', 7, 1, 0, 0);
