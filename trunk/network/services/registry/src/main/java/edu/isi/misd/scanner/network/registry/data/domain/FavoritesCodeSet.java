 ...
 */
@Entity
@Table(name = "favorites_code_set", schema = "scanner_registry")
public class FavoritesCodeSet implements Serializable 
{
    ...
    public FavoritesCodeSet() {
    }

    public FavoritesCodeSet(Integer conceptId) {
        this.conceptId = conceptId;
    }

    public FavoritesCodeSet(Integer conceptId, String conceptName, Date validStartDate, Date validEndDate, Integer conceptLevel, String conceptClass, Integer vocabularyId, String conceptCode) {
        this.conceptId = conceptId;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FavoritesCodeSet)) {
            return false;
        }
        FavoritesCodeSet other = (FavoritesCodeSet) object;
